...
const studyRoomInfoListMock: MyStudyRoomInfoItem[] = [
    {
        ...
        studyRoomToDoList: [[1, '스터디 자료 파일 다운받고 미리 숙지하기1', true],[2, '스터디 자료 파일 다운받고 미리 숙지하기2',false],
    ...
    },   
    {
        ...
        studyRoomToDoList: [[1, '스터디 방의 투두리스트입니다.1132323', false],[2, '스터디 방2232323232322',false]]
    }
];
