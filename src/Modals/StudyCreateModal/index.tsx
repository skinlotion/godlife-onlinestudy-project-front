...
import './style.css';
import DropDownFirstCategory from 'Modals/Dropdown1Category';

import 'react-calendar/dist/Calendar.css';
import moment from 'moment';
import MyCalendar from 'components/DatePicker';
import ModalSideMenu from 'Modals/ModalSideMenu';
      ...
      <div className='reset-card'>
        ...
        <div className='reset-control-box'>
          ...
          <div className='study-period-container'>
            ...
            {/* <div className="study-period-end-date-icon-box"  >
              <div className='study-period-end-date-icon' >                
              </div>
            </div> */}
          </div>
          ...
          <div className='study-open-container'>
            ...
            { openRoomSelectionCheck ? 
              (<button className='study-open-select'>공개</button>) : (<button className='study-open' onClick={onOpenRoomClickhandler}>공개</button>)
            }
          ...
          <div className='study-cover-image-box'>
            ...
            <div className='study-cover-image-contents'>
              ...
              { studyCoverImage === ''  ? (
                ...
                <div className='study-cover-profile-image' style={{ backgroundImage: `url(${studyCoverImage})` }}>console.log('123123');</div> 
              )}
